...
AE_NAMESPACE_BEGIN(AERMOSS)
    struct AEColor {
        ...
        AEColor(int r, int g, int b, int a) : r(r), g(g), b(b), a(a) {}
        AEColor(int r, int g, int b) : r(r), g(g), b(b), a(255) {}
        AEColor(int r, int g) : r(r), g(g), b(255), a(255) {}
        AEColor(int r) : r(r), g(255), b(255), a(255) {}

        AEColor(float r, float g, float b, float a) : r((int) (r * 255)), g((int) (g * 255)), b((int) (b * 255)), a((int) (a * 255)) {}
        AEColor(float r, float g, float b) : r((int) (r * 255)), g((int) (g * 255)), b((int) (b * 255)), a(255) {}
        AEColor(float r, float g) : r((int) (r * 255)), g((int) (g * 255)), b(0), a(255) {}
        AEColor(float r) : r((int) (r * 255)), g(0), b(0), a(255) {}

        AEColor() : r(0), g(0), b(0), a(255) {}
